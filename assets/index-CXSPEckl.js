...
`;let l=class extends v{render(){const e=g();return i`
    ...
    `}tryAgain(){var e;this.close(),(e=this.doTryAgain)===null||e===void 0||e.call(this)}close(){this.shadowRoot.querySelector("ew-dialog").close()}async _handleClose(){this.parentNode.removeChild(this)}};l.styles=[w,h`
      li + li,
      li > ul {
        margin-top: 8px;
      }
    ...
    `];l=u([p("ewt-no-port-picked-dialog")],l);const f=async t=>{const e=document.createElement("ewt-no-port-picked-dialog");return e.doTryAgain=t,document.body.append(e),!0};export{f as openNoPortPickedDialog};
